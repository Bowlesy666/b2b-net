...
from .views import CreateReferralsView, ReferralsListView, ReferralsUpdateView, ReferralsArchiveListView, ReferralsArchiveView, ReferralsConfirmAgreementView, ReferralsCancelView
